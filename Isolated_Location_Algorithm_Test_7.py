...
"""This function computes the great cirle distance (in Km) sum between for
   a given latitude (lat) and longitude (lon) and the other locations in the
   dataset and saves the result in respective location's "Distance_Sum" """
